...
class Discipline(Base):
    ...
    teacher = relationship("Teacher", backref="disciplines", innerjoin=True)
...
class Grade(Base):
    ...
    student = relationship("Student", backref="grade", innerjoin=True)
    discipline = relationship("Discipline", backref="grade", innerjoin=True)
